...
*/}
                ...
                <title>
                    {" "}
                    Delhi Public School | Top School in Jaipur, Best School in Jaipur, CBSE
                    School in Jaipur{" "}
                </title>
                <meta
                    name="description"
                    content="Delhi Public School, Jaipur is one of the most distinguished CBSE schools in the city, committed to providing holistic education for the all-round development of the students. The dedicated team of educators fosters not only individual growth, but also awaken a keen desire in their students, to make a positive contribution to society and the world at large."
                />
                <meta
                    name="keywords"
                    content="Schools in Jaipur, Best Schools in Jaipur, School in Jaipur, Best School in Jaipur, School Jaipur, Jaipur Schools, Delhi Public School Jaipur"
                />
                ...
                {/*<link rel="stylesheet" href="css/jquery.magnify.css"  type="text/css">*/}
                ...
                <link
                    href="https://fonts.googleapis.com/css?family=Roboto+Slab|Vollkorn"
                    rel="stylesheet"
                />
                <link
                    href="https://fonts.googleapis.com/css?family=Alegreya|Cormorant+Garamond|Libre+Baskerville|Playfair+Display|Source+Serif+Pro"
                    rel="stylesheet"
                />
                {/* login page -*/}
                <link
                ...
                {/* Meta Pixel Code */}
                <noscript>
                    &lt;img alt="DPS Jaipur" height="1" width="1" style="display:none"
                    src="https://www.facebook.com/tr?id=1103484520450214&amp;amp;ev=PageView&amp;amp;noscript=1"
                    /&gt;
                </noscript>
                {/* End Meta Pixel Code */}
                {/* Google Tag Manager (noscript) */}
                <noscript>
                    &lt;iframe src="https://www.googletagmanager.com/ns.html?id=GTM-N797XJ5"
                    height="0" width="0"
                        ...
                        <ul className={(styles.sfMenu, styles.clearfix)}>
                            ...
                            <li className={(styles.wow, styles.fadeInLeft, styles.animate)} data-wow-delay="0.8s">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a href="Performing-Arts-Studios.html">Performing Arts Studios</a>
                                    </li>
                                    <li>
                ...
                <div className={(styles.nav2, styles.mobileView)}>
                    ...
                    <ul className={styles.drop2}>
                        ...
                        {/*<li><a href="pdf/download_187_6.pdf" target="_blank">RTE Notification 2019</a></li>*/}
                        <li>
                            <a href="images/dps-jaipur-RTE-Notification-2020.jpg" target="_blank">
                                RTE Notification 2020
                            </a>
                        </li>
                        <li>
                            <a href="International-Links.html">International Links</a>
                        </li>
                        <li>
                            <a href="login/index.html">Student Login</a>
                        </li>
                        <li>
                            <a href="teacherLogin/index.html">Staff Login</a>
                        </li>
                    </ul>
                </div>
                {/* Mobile Menu End */}
                        ...
                        <div className={styles.row}>
                            ...
                            <div className={styles.span9}>
                                <ul>
                                    ...
                                    <li>
                                        <a href="teacherLogin/index.html" target="_blank">
                                            Staff Login
                                        </a>
                                    </li>
                                </ul>
                                    ...
                                    <div className={styles.topSocials} style={{ lineHeight: 120 }}>
                                        <ul>
                                            <li>
                                                ...
                                                >
                                                    <img
                                                        src="images/dps-jaipur-fb-icon.png"
                                                        title="Facebook"
                                                        alt="DPS Jaipur"
                                                    />
                                                </a>
                                            ...
                                            <li>
                                                ...
                                                >
                                                    <img
                                                        src="images/dps-jaipur-instagram.png"
                                                        title="Instagram"
                                                        alt="DPS Jaipur"
                                                    />
                                                </a>
                                            </li>
                                            {/* <li><a href="https://www.instagram.com/dpsjaipurbhankrota/?r=nametag" target="_blank"><img src="images/instagram.png" title="Instagram"></a></li> */}
                                            <li>
                                                <a
                                                ...
                                                >
                                                    <img
                                                        src="images/dps-jaipur-chrome_youtube.png"
                                                        title="Youtube"
                                                        alt="DPS Jaipur"
                                                    />
                                                </a>
                                            ...
                                            <li>
                                                <a
                                                    href="https://api.whatsapp.com/send?phone=+919116405333"
                                                    target="_blank"
                                                >
                                                    <img
                                                        src="images/dps-jaipur-whatsapp.png"
                                                        title="Whatsapp"
                                                        alt="DPS Jaipur"
                                                    />
                                                </a>
                                            ...
                                            <li>
                                                <a href="https://twitter.com/DPSJaipur" target="_blank">
                                                    <img
                                                        src="images/dps-jaipur-twitter.png"
                                                        title="Whatsapp"
                                                        alt="DPS Jaipur"
                                                    />
                                                </a>
                                        ...
                                        <ul className={(styles.sfMenu, styles.clearfix)}>
                                            ...
                                            <li class="" data-wow-delay="0.3s">
                                                ...
                                                <ul>
                                                    ...
                                                    <li>
                                                        <a href="Management-Committee.html">
                                            ...
                                            <li class="" data-wow-delay="0.21s">
                                                ...
                                                <ul>
                                                    <li>
                                                        <a href="Admission-Information.html">
                                            ...
                                            <li class="" data-wow-delay="0.26s">
                                                ...
                                                <ul>
                                                    ...
                                                    <li>
                                                        <a href="Experiential-Learning.html">
                                                ...
                                                <ul>
                                                    ...
                                                    <li>
                                                        ...
                                                        <ul className={styles.subMenu}>
                                                            ...
                                                            <li>
                                                                <a href="social-initiative.html">
                                                                    Shiksha Kendra Photos
                                                                </a>
                                                            </li>
                                                        </ul>
                                                    </li>
                    ...
                    <div className={styles.callFloatDivMayank}>
                        <div className={styles.innerCallFloatMayank}>
                            ...
                            >
                                ...
                                <form
                                    action="https://dpsbhk.edunexttechnologies.com/Exclusion/CreateStudentEnquiry"
                                    method="post"
                                    ...
                                    <div className={(styles.formInputDiv, styles.formfieldId)}>
                                        <div className={styles.formGroup}>
                                            ...
                                            >
                                                ...
                                                <option value={17}>Pre - Nursery</option>
                    ...
                    <div class="">
                        ...
                        <div id="myModal" className={styles.revealModal} style={{ zIndex: 100000 }}>
                            ...
                            <div style={{ padding: 10, color: "#fff", textAlign: "justify" }}>
                                ...
                                <p>
                                    <a href="https://bit.ly/3MmjHza" />
                                    <a href="https://bit.ly/3MmjHza">RUSH TO REGISTER</a>
                                </p>{" "}
                            ...
                            <div className={styles.lsLayer}>
                                ...
                                <p
                                    ...
                                    style={{
                                        ...
                                        delayin: 400,
                                        delayout: 1600,
                                        background: "rgb(4 139 72 / .5)",
                                        color: "#fff",
                                        padding: "0px 20px",
                                        fontSize: 22,
                                        font: '400 28px "poppins"',
                                        paddingBottom: 10,
                                        boxShadow: "0 1px 1px #03723b",
                                        fontWeight: 600,
                                        ...
                                        >
                                            <ul>
                                                <li>
                                                    ...
                                                    >
                                                        Admissions open for Session 2023-2024 ( Classes
                                                        Pre-Nursery to IX &amp; XI )
                                                    </a>
                                                </li>{" "}
                                                <li>
                                                    &nbsp;&nbsp;&nbsp;
                        ...
                        <div className={styles.firstFooter}>
                            ...
                            <div className={(styles.quickLinks, styles.footBox)}>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a
                                            href="upload/attach/933981681293940_new_RTE.pdf"
                                            target="_blank"
                                        >
                                            RTE Notification 2023
                                        </a>
                                    </li>
                                    <li>
                                        <a
                                    ...
                                    <li>
                                        <a href="https://www.dpsjaipur.com/message.html" target="_blank">
                                            PTA Registration
                                        </a>
                                    </li>
                                    <li>
                                ...
                                <div className={styles.conatctBox}>
                                    <div className={styles.contact}>
                                        ...
                                        <p>
                                            ...
                                            <br />
                                            E-mail :{" "}
                                            <a href="mailto: info@dpsjaipur.com">info@dpsjaipur.com</a>,
                                            <a href="mailto: admission@dpsjaipur.com">
                                                admission@dpsjaipur.com
                                            </a>
                                            <br />
                                            <a href="#" title="DPS Jaipur">
                                                Visitor Counter -{" "}
                                                <img
                                                    style={{ width: 142, marginLeft: 5 }}
                        ...
                        <footer className={styles.bottom}>
                            ...
                            <div className={styles.ecis}>
                                <p>
                                    ...
                                    <a
                                        style={{ color: "#fff" }}
                                        href="https://edunexttechnologies.com/"
                                    >
